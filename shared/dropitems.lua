    ...
    combatpdw_scope = `w_at_scope_medium`,
      ...
      clean_card = `p_ld_id_card_002`,
        ...
        weapon_glock19gen4 = `glock19gen4`,
          ...
          --NewLife
          naveta_plastic = `prop_crate_11c`,
          -- Fermier - plante legume si fructe
          bzzz_plants_cucumber_04 = `bzzz_plants_cucumber_04`, -- castravete
          bzzz_plants_eggplant_04 = `bzzz_plants_eggplant_04`, -- vanata
          prop_pineapple = `prop_pineapple`, -- ananas
          bzzz_garden_plant_carrot_d = `bzzz_garden_plant_carrot_d`, -- morcov
          bzzz_plants_potato_04 = `bzzz_plants_potato_04`, -- cartof
          bzzz_plants_tomato_04 = `bzzz_plants_tomato_04`, -- o rosie
          bzzz_plants_melon_04 = `bzzz_plants_melon_04`, -- pepene
          bzzz_plants_melon_05 = `bzzz_plants_melon_05`, -- jumatate de pepene
          bzzz_plants_melon_06 = `bzzz_plants_melon_06`, -- felie de pepene
          bzzz_plants_onion_04 = `bzzz_plants_onion_04`, -- ceapa
          bzzz_plants_blueberry_basket_a = `bzzz_plants_blueberry_basket_a`, -- cos afine gol
          bzzz_plants_blueberry_basket_b = `bzzz_plants_blueberry_basket_b`, -- cos afine plin
          bzzz_plants_cucumber_05 = `bzzz_plants_cucumber_05`, -- cutie castraveti goala
          bzzz_plants_cucumber_06 = `bzzz_plants_cucumber_06`, -- cutie castraveti plina
          bzzz_garden_plant_carrot_e = `bzzz_garden_plant_carrot_e`, -- cutie castraveti plina
          bzzz_plants_eggplant_05 = `bzzz_plants_eggplant_05`, -- cutie vinete goala
          bzzz_plants_eggplant_06 = `bzzz_plants_eggplant_06`, -- cutie vinete plina
          bzzz_plants_peas_basket_a = `bzzz_plants_peas_basket_a`, -- cos mazare gol
          bzzz_plants_peas_basket_b = `bzzz_plants_peas_basket_b`, -- cos mazare plin
          bzzz_plants_strawberry_05 = `bzzz_plants_strawberry_05`, -- cos capsuni gol
          bzzz_plants_strawberry_06 = `bzzz_plants_strawberry_06`, -- cos capsuni plin
          bzzz_plants_tomato_05 = `bzzz_plants_tomato_05`, -- cutie rosii goala
          bzzz_plants_tomato_06 = `bzzz_plants_tomato_06`, -- cutie rosii plina
	  -- Ilegale
	  bzzz_new_tobacco_leaves_b = `bzzz_new_tobacco_leaves_b`, -- frunze de tutun
	  bani_impachetati = `prop_poly_bag_money`,
	  billetera = `prop_ld_wallet_pickup`,
	  weapontint_black = `prop_paint_spray01a`,
	  weapontint_green = `prop_paint_spray01a`,
	  weapontint_gold = `prop_paint_spray01a`,
	  weapontint_pink = `prop_paint_spray01a`,
	  weapontint_army = `prop_paint_spray01a`,
	  weapontint_lspd = `prop_paint_spray01a`,
	  weapontint_orange = `prop_paint_spray01a`,
          weapontint_plat = `prop_paint_spray01a`,
	  handcuffs = `p_cs_cuffs_02_s`,
	  weapon_flashlight = `prop_cs_police_torch`,
